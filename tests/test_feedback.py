...
class TestFeedbackStore:
    ...
    def test_initialization_creates_table(self, temp_db, test_user_id):
        ...
        store = FeedbackStore(temp_db, test_user_id)
    ...
    def test_add_like_feedback(self, temp_db, test_user_id):
        """Test adding a like."""
        store = FeedbackStore(temp_db, test_user_id)
    ...
    def test_add_dislike_feedback(self, temp_db, test_user_id):
    ...
    def test_add_rating(self, temp_db, test_user_id):
    ...
    def test_get_liked_recipe_ids(self, temp_db, test_user_id):
    ...
    def test_get_liked_recipe_ids_with_limit(self, temp_db, test_user_id):
    ...
    def test_get_disliked_recipe_ids(self, temp_db, test_user_id):
    ...
    def test_get_feedback_for_recipe(self, temp_db, test_user_id):
    ...
    def test_get_average_rating(self, temp_db, test_user_id):
    ...
    def test_get_average_rating_no_ratings(self, temp_db, test_user_id):
    ...
    def test_get_preferred_cuisines_from_likes(self, temp_db, test_user_id):
    ...
    def test_get_preferred_cuisines_empty(self, temp_db, test_user_id):
