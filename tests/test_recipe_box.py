...
def temp_db(tmp_path):
    ...
    cursor.execute("INSERT INTO recipes VALUES ('789', 'Third Recipe')")
    conn.commit()
    conn.close()
...
class TestRecipeBoxStore:
    ...
    def test_save_recipe(self, temp_db):
    ...
    def test_save_recipe_with_notes(self, temp_db):
    ...
    def test_save_duplicate_recipe_raises_error(self, temp_db):
    ...
    def test_get_saved_recipes(self, temp_db):
    ...
    def test_get_saved_recipes_with_limit(self, temp_db):
    ...
    def test_get_saved_recipes_empty_box(self, temp_db):
    ...
    def test_remove_recipe(self, temp_db):
    ...
    def test_remove_nonexistent_recipe(self, temp_db):
    ...
    def test_is_saved_true(self, temp_db):
    ...
    def test_is_saved_false(self, temp_db):
        """Test checking if a recipe is not saved."""
        store = RecipeBoxStore(temp_db)

        assert store.is_saved("999") is False

    def test_saved_recipe_model(self, temp_db):
